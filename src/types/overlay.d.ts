...
declare namespace AMap {
  ...
  > {
    ...
    moveAlong(
      path: Array<LngLat> | Array<Vector> | Array<MoveAlongObj>,
      opts?: MoveAlongOptions,
    ): void;
   ...
   * Polygon 编辑器
   */
  class PolygonEditor extends MapEventListener<
    'end' | 'move' | 'addnode' | 'removenode' | 'adjust' | 'add'
  > {
  ...
  > {
    ...
    constructor(
      data: MassMarkersDataOptions,
      opts?: Array<MassMarkersOptions> | MassMarkersOptions,
    );
    setMap(map: Map | null): void;
    getMap(): Map;
