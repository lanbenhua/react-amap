...
[![npm version](https://img.shields.io/npm/v/@lbh7/react-amap-polyline.svg)](https://www.npmjs.com/package/@lbh7/react-amap-polyline)
[![Downloads](https://img.shields.io/npm/dm/@lbh7/react-amap-polyline.svg?style=flat)](https://www.npmjs.com/package/@lbh7/react-amap-polyline)

构造折线对象，支持 `lineString` 和 `MultiLineString`。

```jsx
import { Polyline } from '@lbh7/react-amap';
// 或者单独安装使用
import { Polyline } from '@lbh7/react-amap-polyline';
```
