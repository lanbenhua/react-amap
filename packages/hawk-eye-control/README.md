...
[![npm version](https://img.shields.io/npm/v/@lbh7/react-amap-hawk-eye-control.svg)](https://www.npmjs.com/package/@lbh7/react-amap-hawk-eye-control)
[![Downloads](https://img.shields.io/npm/dm/@lbh7/react-amap-hawk-eye-control.svg?style=flat)](https://www.npmjs.com/package/@lbh7/react-amap-hawk-eye-control)

鹰眼控件，用于显示缩略地图，显示于地图右下角，可以随主图的视口变化而变化，也可以配置成固定位置实现类似于南海附图的效果。

```jsx
import { HawkEyeControl } from '@lbh7/react-amap';
// 或者单独安装使用
import { HawkEyeControl } from '@lbh7/react-amap-hawk-eye-control';
```
...
import { Map, APILoader, HawkEyeControl } from '@lbh7/react-amap';
