...
[![npm version](https://img.shields.io/npm/v/@lbh7/react-amap-tile-layer.svg)](https://www.npmjs.com/package/@lbh7/react-amap-tile-layer)
[![Downloads](https://img.shields.io/npm/dm/@lbh7/react-amap-tile-layer.svg?style=flat)](https://www.npmjs.com/package/@lbh7/react-amap-tile-layer)

切片图层，用户可以用此组件灵活加载各种切片图层。 [AMap API](https://lbs.amap.com/api/jsapi-v2/documentation#tilelayer)

```jsx
import { TileLayer } from '@lbh7/react-amap';
// 或者单独安装使用
import { TileLayer } from '@lbh7/react-amap-tile-layer';
```
...
import { Map, APILoader, Marker,TileLayer ,TileLayerType} from '@lbh7/react-amap';
