...
[![npm version](https://img.shields.io/npm/v/@lbh7/react-amap-mass-marks.svg)](https://www.npmjs.com/package/@lbh7/react-amap-mass-marks)
[![Downloads](https://img.shields.io/npm/dm/@lbh7/react-amap-mass-marks.svg?style=flat)](https://www.npmjs.com/package/@lbh7/react-amap-mass-marks)

在地图上加载海量点，适合需要显示大量 `Marker` 的场景。

```jsx
import { MassMarks } from '@lbh7/react-amap';
// 或者单独安装使用
import { MassMarks } from '@lbh7/react-amap-mass-marks';
```
