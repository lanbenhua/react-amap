...
[![npm version](https://img.shields.io/npm/v/@lbh7/react-amap-rectangle.svg)](https://www.npmjs.com/package/@lbh7/react-amap-rectangle)
[![Downloads](https://img.shields.io/npm/dm/@lbh7/react-amap-rectangle.svg?style=flat)](https://www.npmjs.com/package/@lbh7/react-amap-rectangle)

构造圆形对象，通过 RectangleOptions 指定多边形样式

```jsx
import { Rectangle } from '@lbh7/react-amap';
// 或者单独安装使用
import { Rectangle } from '@lbh7/react-amap-rectangle';
```
...
import { Map, APILoader, Rectangle } from '@lbh7/react-amap';
