...
[![npm version](https://img.shields.io/npm/v/@lbh7/react-amap-map.svg)](https://www.npmjs.com/package/@lbh7/react-amap-map)
[![Downloads](https://img.shields.io/npm/dm/@lbh7/react-amap-map.svg?style=flat)](https://www.npmjs.com/package/@lbh7/react-amap-map)
...
// 或者单独安装使用
import { Map } from '@lbh7/react-amap-map';
```
...
import ReactDOM from 'react-dom';
import { useMap, useMapContext, APILoader, Provider } from '@lbh7/react-amap';
...
```jsx
import { useMapContext, Provider } from '@lbh7/react-amap';
...
import { Map, APILoader, Polyline, ToolBarControl } from '@lbh7/react-amap';
